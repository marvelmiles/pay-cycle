            ...
            <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">JPG, GIF or PNG. Max size 2MB.</p>
                </div>
              </div>
          ...
          {editingBusiness ? (
            <form onSubmit={businessForm.handleSubmit(onBusinessSubmit)} className="space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Recommended 400x400. Max 2MB.</p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="grid grid-cols-2 gap-x-12 gap-y-4 flex-1">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Public Slug</p>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className="text-sm font-semibold text-gray-900">{business?.slug}</span>
                    <span className="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded uppercase font-bold">Live</span>
                  </div>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Base Currency</p>
                  <p className="text-sm font-semibold text-gray-900 mt-0.5">NGN (Nigerian Naira)</p>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Default Timezone</p>
                  <p className="text-sm font-semibold text-gray-900 mt-0.5">Africa/Lagos</p>
                </div>
              </div>
            </div>
          )}
